...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_jobs_state_requested_at_ms", "jobs", ["state", "requested_at_ms"], unique=False
    )
    op.create_table(
        "ingestion_runs",
        sa.Column("id", sa.Text(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["account_id"], ["accounts.id"], name="fk_ingestion_runs_account_id"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["ingestion_id"], ["ingestion_runs.id"], name="fk_raw_records_ingestion_id"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["account_id"], ["accounts.id"], name="fk_profile_snapshots_account_id"
        ),
        sa.ForeignKeyConstraint(
            ["ingestion_id"], ["ingestion_runs.id"], name="fk_profile_snapshots_ingestion_id"
        ),
        sa.ForeignKeyConstraint(
            ["raw_record_id"], ["raw_records.id"], name="fk_profile_snapshots_raw_record_id"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("raw_record_id", name="uq_profile_snapshots_raw_record_id"),
    )
    op.create_index(
        "ix_profile_snapshots_account_id", "profile_snapshots", ["account_id"], unique=False
    )
    op.create_index(
        "ix_profile_snapshots_ingestion_id", "profile_snapshots", ["ingestion_id"], unique=False
    )
    op.create_table(
        "matches",
        sa.Column("id", sa.Text(), nullable=False),
    ...
    op.create_index(
        "ix_matches_account_occurred_at_ms",
        "matches",
        ["account_id", "occurred_at_ms"],
        unique=False,
    )
    op.create_table(
        "match_observations",
        ...
        sa.Column("observed_at_ms", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["ingestion_id"], ["ingestion_runs.id"], name="fk_match_observations_ingestion_id"
        ),
        sa.ForeignKeyConstraint(
            ["match_id"], ["matches.id"], name="fk_match_observations_match_id"
        ),
        sa.ForeignKeyConstraint(
            ["raw_record_id"], ["raw_records.id"], name="fk_match_observations_raw_record_id"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("raw_record_id", name="uq_match_observations_raw_record_id"),
    )
    op.create_index(
        "ix_match_observations_match_id", "match_observations", ["match_id"], unique=False
    )
    op.create_index(
        "ix_match_observations_ingestion_id", "match_observations", ["ingestion_id"], unique=False
    )
    op.create_table(
        "quarantine_records",
        sa.Column("id", sa.Text(), nullable=False),
        ...
        sa.CheckConstraint(
            "field_errors_json IS NULL OR json_valid(field_errors_json)",
            name="ck_quarantine_records_field_errors_json",
        ),
        sa.CheckConstraint(
            "status IN ('OPEN', 'RESOLVED', 'IGNORED')", name="ck_quarantine_records_status"
        ),
        sa.ForeignKeyConstraint(
            ["account_id"], ["accounts.id"], name="fk_quarantine_records_account_id"
        ),
        sa.ForeignKeyConstraint(
            ["raw_record_id"], ["raw_records.id"], name="fk_quarantine_records_raw_record_id"
        ),
        sa.ForeignKeyConstraint(
            ["resolution_match_id"],
            ["matches.id"],
            name="fk_quarantine_records_resolution_match_id",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("raw_record_id", name="uq_quarantine_records_raw_record_id"),
    )
    op.create_index(
        "ix_quarantine_records_account_id", "quarantine_records", ["account_id"], unique=False
    )
    op.create_index(
        "ix_quarantine_records_resolution_match_id",
        "quarantine_records",
        ["resolution_match_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "source_logical_sha256", name="uq_legacy_sources_source_logical_sha256"
        ),
    )
    op.create_table(
        "legacy_rows",
        ...
        sa.CheckConstraint(
            "table_name IN ('players', 'matches')", name="ck_legacy_rows_table_name"
        ),
        sa.CheckConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["quarantine_id"], ["quarantine_records.id"], name="fk_legacy_rows_quarantine_id"
        ),
        sa.ForeignKeyConstraint(
            ["raw_record_id"], ["raw_records.id"], name="fk_legacy_rows_raw_record_id"
        ),
        sa.ForeignKeyConstraint(
            ["source_id"], ["legacy_sources.id"], name="fk_legacy_rows_source_id"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "source_id",
            ...
            "legacy_pk",
            "ordinal",
            name="uq_legacy_rows_source_table_pk_ordinal",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["ingestion_id"], ["ingestion_runs.id"], name="fk_recovery_links_ingestion_id"
        ),
    ...
    op.create_index(
        "ix_recovery_links_ingestion_id", "recovery_links", ["ingestion_id"], unique=False
    )
    op.create_table(
        "settings",
        sa.Column("id", sa.Integer(), nullable=False),
