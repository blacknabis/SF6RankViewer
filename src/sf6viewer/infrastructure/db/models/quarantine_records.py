...
class QuarantineRecordModel(Base):
    ...
    raw_record_id: Mapped[str] = mapped_column(
        ForeignKey("raw_records.id", name="fk_quarantine_records_raw_record_id"), nullable=False
    )
    account_id: Mapped[int | None] = mapped_column(
        ForeignKey("accounts.id", name="fk_quarantine_records_account_id")
    )
    ...
    resolution_match_id: Mapped[str | None] = mapped_column(
        ForeignKey("matches.id", name="fk_quarantine_records_resolution_match_id")
    )
