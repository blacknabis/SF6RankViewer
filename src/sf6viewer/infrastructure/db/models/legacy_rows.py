...
class LegacyRowModel(Base):
    ...
    source_id: Mapped[str] = mapped_column(
        ForeignKey("legacy_sources.id", name="fk_legacy_rows_source_id"), nullable=False
    )
    ...
    raw_record_id: Mapped[str | None] = mapped_column(
        ForeignKey("raw_records.id", name="fk_legacy_rows_raw_record_id")
    )
    match_id: Mapped[str | None] = mapped_column(
        ForeignKey("matches.id", name="fk_legacy_rows_match_id")
    )
    quarantine_id: Mapped[str | None] = mapped_column(
        ForeignKey("quarantine_records.id", name="fk_legacy_rows_quarantine_id")
    )
